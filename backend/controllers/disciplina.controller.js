...
endpointsFunction.createSubject = async (req, res) => {
...
endpointsFunction.getAllSubjects = async (req, res) => {
  try {
...
endpointsFunction.getSubjectById = async (req, res) => {
  try {
    const { id } = req.params;
...
endpointsFunction.updateSubject = async (req, res) => {
  const { id } = req.params;
  const { name, totalHours } = req.body;
...
endpointsFunction.deleteSubject = async (req, res) => {
  const { id } = req.params;
